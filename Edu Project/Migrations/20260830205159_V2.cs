        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descciption = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonsWatch", x => new { x.StudentId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_LessonsWatch_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LessonsWatch_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Finalgrades", x => new { x.FinalexamId, x.StudentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Finalgrades_Exams_FinalexamId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Exams_FinalexamId",
                        column: x => x.FinalexamId,
                        principalTable: "Exams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Questions_Exams_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Exams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quizgrades", x => new { x.StudentId, x.quizId });
                    table.ForeignKey(
                        name: "FK_Quizgrades_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quizgrades_Exams_quizId",
                        column: x => x.quizId,
                        principalTable: "Exams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAnswers", x => new { x.studentId, x.questionId, x.answerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonsWatch_LessonId",
                table: "LessonsWatch",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_FinalexamId",
                table: "Questions",
                column: "FinalexamId");
